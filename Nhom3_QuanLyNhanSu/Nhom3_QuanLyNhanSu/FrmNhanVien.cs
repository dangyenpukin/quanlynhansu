...
namespace Nhom3_QuanLyNhanSu
{
    public partial class FrmNhanVien : Form
    {
        ...
        private void textBox2_Leave(object sender, EventArgs e)//kiểm tra khi rời khỏi textbox đó
        {
            if (textBox2.Text.Trim().Equals(""))
            {
                textBox2.Text = "Nhập Nội Dung Tìm Kiếm...";
                textBox2.ForeColor = Color.Gray;//thay đổi font trong textbox
            }
        }

        private void textBox2_KeyUp(object sender, KeyEventArgs e)//sự kiện đưa ra khi nhả  phím trên bàn phím
        {
